# name and paths
overall_name = "gamm_formants_complex_sigtest_type_1"
...
output.dir = "/scratch/ms1341/r/gamm-sim/formants/complex_sigtest/output_type_1"
...
init.file = "formants_complex_sigtest_type_1_init.r"

# name of config file
config.file = "formants_complex_sigtest_type_1_config_file.R"
