# name and paths
overall_name = "gamm_formants_complex_within_type_1"
...
output.dir = "/scratch/ms1341/r/gamm-sim/formants/complex_within/output_type_1"
...
init.file = "formants_complex_within_type_1_init.r"

# name of config file
config.file = "formants_complex_within_type_1_config_file.R"
