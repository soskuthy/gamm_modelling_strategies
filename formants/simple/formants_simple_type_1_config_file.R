# name and paths
overall_name = "gamm_formants_simple_type_1"
...
output.dir = "/scratch/ms1341/r/gamm-sim/formants/simple/output_type_1"
...
init.file = "formants_simple_type_1_init.r"

# name of config file
config.file = "formants_simple_type_1_config_file.R"
