# name and paths
overall_name = "gamm_formants_complex_across_type_2"
...
output.dir = "/scratch/ms1341/r/gamm-sim/formants/complex_across/output_type_2"
...
init.file = "formants_complex_across_type_2_init.r"

# name of config file
config.file = "formants_complex_across_type_2_config_file.R"
