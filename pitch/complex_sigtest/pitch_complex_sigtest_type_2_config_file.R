# name and paths
overall_name = "gamm_pitch_complex_sigtest_type_2"
...
output.dir = "/scratch/ms1341/r/gamm-sim/pitch/complex_sigtest/output_type_2"
...
init.file = "pitch_complex_sigtest_type_2_init.r"

# name of config file
config.file = "pitch_complex_sigtest_type_2_config_file.R"
